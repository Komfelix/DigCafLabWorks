...
# Вызов функций count_letters() calculate_frequency()
letters_count_main_str = count_letters(main_str)
letters_frequency_main_str = calculate_frequency(letters_count_main_str)

# TODO Распечатайте в столбик букву и её частоту в тексте
for key, value in letters_frequency_main_str.items():
